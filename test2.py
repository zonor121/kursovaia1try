...
class ModernGraphVisualizer(QMainWindow):
    ...
    def create_top_panel(self, layout):
        ...
        self.pause_btn = self.create_control_button("▶", "Старт", self.toggle_pause)
...
Отрицательные веса: {negative_weights}"""
    ...
    def toggle_pause(self):
        ...
        self.pause_btn.setText("⏸" if not self.pause else "▶")
        self.pause_btn.setToolTip("Пауза" if not self.pause else "Старт")
